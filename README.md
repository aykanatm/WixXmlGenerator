...
**-outputFile:** This file contains the XML that is generated by the tool. While the file will have XML formatted text, there is no restriction on the file extension. It can be anything.
